...
{
    public Transform targetLocation; //Location of where the player will spawn inside an interior | Assigned in Unity inspector - different location needs to be set for every interior
