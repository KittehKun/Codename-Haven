...
public class PlayerRaidInventory : UdonSharpBehaviour
{
    ...
    public int StoragePointCap {get; set;} = 25; //Used for calculating maximum storage points. Above variable is used for current points.
    ...
    void Start()
    {
        //Set StoragePointCap to 25 | By default players will have 25 points without a backpack
